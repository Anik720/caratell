  ...
  return (
    <div className="bg-white w-full h-full">
      <div className={styles['main-error-page']}>
        <svg id="svg1" width="auto" height="290" viewBox="0 0 470 290">
          <defs>
            <path
              id="prefix__a"
        ...
        <h1 className={styles['error-title']}>Woops! Something went wrong in server</h1>
        <h2 className={styles['error-subtitle']}>Try again later</h2>
      </div>
    </div>
  );
};
